#!/usr/bin/env python3
"""
A simple Hello World program that prominently displays the laptop's IP address
"""
...
def main():
    """Print a hello world message and display IP address prominently."""
    # Clear the screen
    ...
    print("\n" + "=" * 60)
    print(f"{'HELLO WORLD SCRIPT EXECUTED':^60}")
    print("=" * 60)
    ...
    print("=" * 60)
    print(f"{'SCRIPT EXECUTED SUCCESSFULLY':^60}")
    print("=" * 60 + "\n")
