...
class Move_SendGoal_Event(metaclass=Metaclass_Move_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robotnik_navigation_msgs/Move_SendGoal_Request, 1>',
        'response': 'sequence<robotnik_navigation_msgs/Move_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_navigation_msgs', 'action'], 'Move_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_navigation_msgs', 'action'], 'Move_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robotnik_navigation_msgs.action import Move_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from robotnik_navigation_msgs.action import Move_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    ...
    from robotnik_navigation_msgs.action._move import Move_SendGoal_Event as Event
...
class Move_GetResult_Event(metaclass=Metaclass_Move_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<robotnik_navigation_msgs/Move_GetResult_Request, 1>',
        'response': 'sequence<robotnik_navigation_msgs/Move_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_navigation_msgs', 'action'], 'Move_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_navigation_msgs', 'action'], 'Move_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robotnik_navigation_msgs.action import Move_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from robotnik_navigation_msgs.action import Move_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    ...
    from robotnik_navigation_msgs.action._move import Move_GetResult_Event as Event
