...
{
public:
  explicit Init_Move_SendGoal_Event_response(::robotnik_navigation_msgs::action::Move_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_navigation_msgs::action::Move_SendGoal_Event response(::robotnik_navigation_msgs::action::Move_SendGoal_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_navigation_msgs::action::Move_SendGoal_Event msg_;
};

class Init_Move_SendGoal_Event_request
{
public:
  explicit Init_Move_SendGoal_Event_request(::robotnik_navigation_msgs::action::Move_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Move_SendGoal_Event_response request(::robotnik_navigation_msgs::action::Move_SendGoal_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Move_SendGoal_Event_request info(::robotnik_navigation_msgs::action::Move_SendGoal_Event::_info_type arg)
  {
...
template<>
inline
auto build<::robotnik_navigation_msgs::action::Move_SendGoal_Event>()
{
  return robotnik_navigation_msgs::action::builder::Init_Move_SendGoal_Event_info();
}
...
{
public:
  explicit Init_Move_GetResult_Event_response(::robotnik_navigation_msgs::action::Move_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_navigation_msgs::action::Move_GetResult_Event response(::robotnik_navigation_msgs::action::Move_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_navigation_msgs::action::Move_GetResult_Event msg_;
};

class Init_Move_GetResult_Event_request
{
public:
  explicit Init_Move_GetResult_Event_request(::robotnik_navigation_msgs::action::Move_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Move_GetResult_Event_response request(::robotnik_navigation_msgs::action::Move_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Move_GetResult_Event_request info(::robotnik_navigation_msgs::action::Move_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::robotnik_navigation_msgs::action::Move_GetResult_Event>()
{
  return robotnik_navigation_msgs::action::builder::Init_Move_GetResult_Event_info();
}
