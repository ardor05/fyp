...
[[deprecated("use robotnik_navigation_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robotnik_navigation_msgs::action::Move_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robotnik_navigation_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robotnik_navigation_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const robotnik_navigation_msgs::action::Move_SendGoal_Event & msg)
{
  return robotnik_navigation_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<robotnik_navigation_msgs::action::Move_SendGoal_Event>()
{
  return "robotnik_navigation_msgs::action::Move_SendGoal_Event";
}

template<>
inline const char * name<robotnik_navigation_msgs::action::Move_SendGoal_Event>()
{
  return "robotnik_navigation_msgs/action/Move_SendGoal_Event";
}

template<>
struct has_fixed_size<robotnik_navigation_msgs::action::Move_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robotnik_navigation_msgs::action::Move_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<robotnik_navigation_msgs::action::Move_SendGoal_Request>::value && has_bounded_size<robotnik_navigation_msgs::action::Move_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robotnik_navigation_msgs::action::Move_SendGoal_Event>
  : std::true_type {};
...
[[deprecated("use robotnik_navigation_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robotnik_navigation_msgs::action::Move_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robotnik_navigation_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robotnik_navigation_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const robotnik_navigation_msgs::action::Move_GetResult_Event & msg)
{
  return robotnik_navigation_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<robotnik_navigation_msgs::action::Move_GetResult_Event>()
{
  return "robotnik_navigation_msgs::action::Move_GetResult_Event";
}

template<>
inline const char * name<robotnik_navigation_msgs::action::Move_GetResult_Event>()
{
  return "robotnik_navigation_msgs/action/Move_GetResult_Event";
}

template<>
struct has_fixed_size<robotnik_navigation_msgs::action::Move_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robotnik_navigation_msgs::action::Move_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<robotnik_navigation_msgs::action::Move_GetResult_Request>::value && has_bounded_size<robotnik_navigation_msgs::action::Move_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robotnik_navigation_msgs::action::Move_GetResult_Event>
  : std::true_type {};
