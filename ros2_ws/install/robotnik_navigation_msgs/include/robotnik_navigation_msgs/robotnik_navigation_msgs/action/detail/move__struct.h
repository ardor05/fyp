...
enum
{
  robotnik_navigation_msgs__action__Move_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_navigation_msgs__action__Move_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Move in the package robotnik_navigation_msgs.
typedef struct robotnik_navigation_msgs__action__Move_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_navigation_msgs__action__Move_SendGoal_Request__Sequence request;
  robotnik_navigation_msgs__action__Move_SendGoal_Response__Sequence response;
} robotnik_navigation_msgs__action__Move_SendGoal_Event;

// Struct for a sequence of robotnik_navigation_msgs__action__Move_SendGoal_Event.
typedef struct robotnik_navigation_msgs__action__Move_SendGoal_Event__Sequence
{
...
enum
{
  robotnik_navigation_msgs__action__Move_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_navigation_msgs__action__Move_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Move in the package robotnik_navigation_msgs.
typedef struct robotnik_navigation_msgs__action__Move_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_navigation_msgs__action__Move_GetResult_Request__Sequence request;
  robotnik_navigation_msgs__action__Move_GetResult_Response__Sequence response;
} robotnik_navigation_msgs__action__Move_GetResult_Event;

// Struct for a sequence of robotnik_navigation_msgs__action__Move_GetResult_Event.
typedef struct robotnik_navigation_msgs__action__Move_GetResult_Event__Sequence
{
