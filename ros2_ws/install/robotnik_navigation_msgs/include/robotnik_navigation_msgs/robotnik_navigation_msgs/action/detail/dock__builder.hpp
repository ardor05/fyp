...
class Init_Dock_SendGoal_Event_response
{
public:
  explicit Init_Dock_SendGoal_Event_response(::robotnik_navigation_msgs::action::Dock_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_navigation_msgs::action::Dock_SendGoal_Event response(::robotnik_navigation_msgs::action::Dock_SendGoal_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_navigation_msgs::action::Dock_SendGoal_Event msg_;
};

class Init_Dock_SendGoal_Event_request
{
public:
  explicit Init_Dock_SendGoal_Event_request(::robotnik_navigation_msgs::action::Dock_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Dock_SendGoal_Event_response request(::robotnik_navigation_msgs::action::Dock_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Dock_SendGoal_Event_response(msg_);
  }
...
class Init_Dock_SendGoal_Event_info
{
public:
  Init_Dock_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Dock_SendGoal_Event_request info(::robotnik_navigation_msgs::action::Dock_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Dock_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::robotnik_navigation_msgs::action::Dock_SendGoal_Event>()
{
  return robotnik_navigation_msgs::action::builder::Init_Dock_SendGoal_Event_info();
}
...
class Init_Dock_GetResult_Event_response
{
public:
  explicit Init_Dock_GetResult_Event_response(::robotnik_navigation_msgs::action::Dock_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_navigation_msgs::action::Dock_GetResult_Event response(::robotnik_navigation_msgs::action::Dock_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_navigation_msgs::action::Dock_GetResult_Event msg_;
};

class Init_Dock_GetResult_Event_request
{
public:
  explicit Init_Dock_GetResult_Event_request(::robotnik_navigation_msgs::action::Dock_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Dock_GetResult_Event_response request(::robotnik_navigation_msgs::action::Dock_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Dock_GetResult_Event_response(msg_);
  }
...
class Init_Dock_GetResult_Event_info
{
public:
  Init_Dock_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Dock_GetResult_Event_request info(::robotnik_navigation_msgs::action::Dock_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Dock_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::robotnik_navigation_msgs::action::Dock_GetResult_Event>()
{
  return robotnik_navigation_msgs::action::builder::Init_Dock_GetResult_Event_info();
}
