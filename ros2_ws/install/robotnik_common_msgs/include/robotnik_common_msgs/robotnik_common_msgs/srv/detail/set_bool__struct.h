...
enum
{
  robotnik_common_msgs__srv__SetBool_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_common_msgs__srv__SetBool_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetBool in the package robotnik_common_msgs.
typedef struct robotnik_common_msgs__srv__SetBool_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_common_msgs__srv__SetBool_Request__Sequence request;
  robotnik_common_msgs__srv__SetBool_Response__Sequence response;
} robotnik_common_msgs__srv__SetBool_Event;

// Struct for a sequence of robotnik_common_msgs__srv__SetBool_Event.
typedef struct robotnik_common_msgs__srv__SetBool_Event__Sequence
{
