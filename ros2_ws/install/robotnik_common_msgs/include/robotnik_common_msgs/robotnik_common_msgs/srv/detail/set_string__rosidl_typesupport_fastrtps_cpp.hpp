...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robotnik_common_msgs
cdr_serialize(
  const robotnik_common_msgs::srv::SetString_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robotnik_common_msgs::srv::SetString_Event & ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robotnik_common_msgs
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotnik_common_msgs, srv, SetString_Event)();
