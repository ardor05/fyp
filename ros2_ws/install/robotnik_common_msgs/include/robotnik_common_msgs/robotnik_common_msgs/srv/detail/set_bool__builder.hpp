...
{
public:
  explicit Init_SetBool_Event_response(::robotnik_common_msgs::srv::SetBool_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_common_msgs::srv::SetBool_Event response(::robotnik_common_msgs::srv::SetBool_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_common_msgs::srv::SetBool_Event msg_;
};

class Init_SetBool_Event_request
{
public:
  explicit Init_SetBool_Event_request(::robotnik_common_msgs::srv::SetBool_Event & msg)
  : msg_(msg)
  {}
  Init_SetBool_Event_response request(::robotnik_common_msgs::srv::SetBool_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetBool_Event_request info(::robotnik_common_msgs::srv::SetBool_Event::_info_type arg)
  {
...
template<>
inline
auto build<::robotnik_common_msgs::srv::SetBool_Event>()
{
  return robotnik_common_msgs::srv::builder::Init_SetBool_Event_info();
}
