...
[[deprecated("use robotnik_common_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robotnik_common_msgs::srv::SetFloat32_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robotnik_common_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robotnik_common_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const robotnik_common_msgs::srv::SetFloat32_Event & msg)
{
  return robotnik_common_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<robotnik_common_msgs::srv::SetFloat32_Event>()
{
  return "robotnik_common_msgs::srv::SetFloat32_Event";
}

template<>
inline const char * name<robotnik_common_msgs::srv::SetFloat32_Event>()
{
  return "robotnik_common_msgs/srv/SetFloat32_Event";
}

template<>
struct has_fixed_size<robotnik_common_msgs::srv::SetFloat32_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robotnik_common_msgs::srv::SetFloat32_Event>
  : std::integral_constant<bool, has_bounded_size<robotnik_common_msgs::srv::SetFloat32_Request>::value && has_bounded_size<robotnik_common_msgs::srv::SetFloat32_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robotnik_common_msgs::srv::SetFloat32_Event>
  : std::true_type {};
