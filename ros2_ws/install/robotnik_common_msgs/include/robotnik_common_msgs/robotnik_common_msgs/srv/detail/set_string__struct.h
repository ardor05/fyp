...
enum
{
  robotnik_common_msgs__srv__SetString_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_common_msgs__srv__SetString_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetString in the package robotnik_common_msgs.
typedef struct robotnik_common_msgs__srv__SetString_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_common_msgs__srv__SetString_Request__Sequence request;
  robotnik_common_msgs__srv__SetString_Response__Sequence response;
} robotnik_common_msgs__srv__SetString_Event;

// Struct for a sequence of robotnik_common_msgs__srv__SetString_Event.
typedef struct robotnik_common_msgs__srv__SetString_Event__Sequence
{
