...
{
public:
  explicit Init_SetInt32_Event_response(::robotnik_common_msgs::srv::SetInt32_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_common_msgs::srv::SetInt32_Event response(::robotnik_common_msgs::srv::SetInt32_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_common_msgs::srv::SetInt32_Event msg_;
};

class Init_SetInt32_Event_request
{
public:
  explicit Init_SetInt32_Event_request(::robotnik_common_msgs::srv::SetInt32_Event & msg)
  : msg_(msg)
  {}
  Init_SetInt32_Event_response request(::robotnik_common_msgs::srv::SetInt32_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetInt32_Event_request info(::robotnik_common_msgs::srv::SetInt32_Event::_info_type arg)
  {
...
template<>
inline
auto build<::robotnik_common_msgs::srv::SetInt32_Event>()
{
  return robotnik_common_msgs::srv::builder::Init_SetInt32_Event_info();
}
