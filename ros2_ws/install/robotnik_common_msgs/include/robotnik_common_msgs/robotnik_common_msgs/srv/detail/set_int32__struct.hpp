...
// IWYU pragma: private, include "robotnik_common_msgs/srv/set_int32.hpp"
...
#ifndef _WIN32
# define DEPRECATED__robotnik_common_msgs__srv__SetInt32_Event __attribute__((deprecated))
#else
# define DEPRECATED__robotnik_common_msgs__srv__SetInt32_Event __declspec(deprecated)
#endif
...
struct SetInt32_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<robotnik_common_msgs::srv::SetInt32_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<robotnik_common_msgs::srv::SetInt32_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<robotnik_common_msgs::srv::SetInt32_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<robotnik_common_msgs::srv::SetInt32_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<robotnik_common_msgs::srv::SetInt32_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<robotnik_common_msgs::srv::SetInt32_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<robotnik_common_msgs::srv::SetInt32_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<robotnik_common_msgs::srv::SetInt32_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__robotnik_common_msgs__srv__SetInt32_Event
    std::shared_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__robotnik_common_msgs__srv__SetInt32_Event
    std::shared_ptr<robotnik_common_msgs::srv::SetInt32_Event_<ContainerAllocator> const>
...
using SetInt32_Event =
  robotnik_common_msgs::srv::SetInt32_Event_<std::allocator<void>>;
...
struct SetInt32
{
  ...
  using Event = robotnik_common_msgs::srv::SetInt32_Event;
};
