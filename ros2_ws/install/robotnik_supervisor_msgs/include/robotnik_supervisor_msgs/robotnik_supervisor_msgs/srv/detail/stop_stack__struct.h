...
enum
{
  robotnik_supervisor_msgs__srv__StopStack_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_supervisor_msgs__srv__StopStack_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/StopStack in the package robotnik_supervisor_msgs.
typedef struct robotnik_supervisor_msgs__srv__StopStack_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_supervisor_msgs__srv__StopStack_Request__Sequence request;
  robotnik_supervisor_msgs__srv__StopStack_Response__Sequence response;
} robotnik_supervisor_msgs__srv__StopStack_Event;

// Struct for a sequence of robotnik_supervisor_msgs__srv__StopStack_Event.
typedef struct robotnik_supervisor_msgs__srv__StopStack_Event__Sequence
{
