...
class Init_StopStack_Event_response
{
public:
  explicit Init_StopStack_Event_response(::robotnik_supervisor_msgs::srv::StopStack_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_supervisor_msgs::srv::StopStack_Event response(::robotnik_supervisor_msgs::srv::StopStack_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_supervisor_msgs::srv::StopStack_Event msg_;
};

class Init_StopStack_Event_request
{
public:
  explicit Init_StopStack_Event_request(::robotnik_supervisor_msgs::srv::StopStack_Event & msg)
  : msg_(msg)
  {}
  Init_StopStack_Event_response request(::robotnik_supervisor_msgs::srv::StopStack_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_StopStack_Event_response(msg_);
  }
...
class Init_StopStack_Event_info
{
public:
  Init_StopStack_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_StopStack_Event_request info(::robotnik_supervisor_msgs::srv::StopStack_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_StopStack_Event_request(msg_);
  }
...
template<>
inline
auto build<::robotnik_supervisor_msgs::srv::StopStack_Event>()
{
  return robotnik_supervisor_msgs::srv::builder::Init_StopStack_Event_info();
}
