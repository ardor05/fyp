...
class Init_StartModule_Event_response
{
public:
  explicit Init_StartModule_Event_response(::robotnik_supervisor_msgs::srv::StartModule_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_supervisor_msgs::srv::StartModule_Event response(::robotnik_supervisor_msgs::srv::StartModule_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_supervisor_msgs::srv::StartModule_Event msg_;
};

class Init_StartModule_Event_request
{
public:
  explicit Init_StartModule_Event_request(::robotnik_supervisor_msgs::srv::StartModule_Event & msg)
  : msg_(msg)
  {}
  Init_StartModule_Event_response request(::robotnik_supervisor_msgs::srv::StartModule_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_StartModule_Event_response(msg_);
  }
...
class Init_StartModule_Event_info
{
public:
  Init_StartModule_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_StartModule_Event_request info(::robotnik_supervisor_msgs::srv::StartModule_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_StartModule_Event_request(msg_);
  }
...
template<>
inline
auto build<::robotnik_supervisor_msgs::srv::StartModule_Event>()
{
  return robotnik_supervisor_msgs::srv::builder::Init_StartModule_Event_info();
}
