...
enum
{
  robotnik_supervisor_msgs__srv__StartStack_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_supervisor_msgs__srv__StartStack_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/StartStack in the package robotnik_supervisor_msgs.
typedef struct robotnik_supervisor_msgs__srv__StartStack_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_supervisor_msgs__srv__StartStack_Request__Sequence request;
  robotnik_supervisor_msgs__srv__StartStack_Response__Sequence response;
} robotnik_supervisor_msgs__srv__StartStack_Event;

// Struct for a sequence of robotnik_supervisor_msgs__srv__StartStack_Event.
typedef struct robotnik_supervisor_msgs__srv__StartStack_Event__Sequence
{
