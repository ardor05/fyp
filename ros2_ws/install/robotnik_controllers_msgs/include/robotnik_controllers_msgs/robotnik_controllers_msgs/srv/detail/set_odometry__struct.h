...
enum
{
  robotnik_controllers_msgs__srv__SetOdometry_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_controllers_msgs__srv__SetOdometry_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetOdometry in the package robotnik_controllers_msgs.
typedef struct robotnik_controllers_msgs__srv__SetOdometry_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_controllers_msgs__srv__SetOdometry_Request__Sequence request;
  robotnik_controllers_msgs__srv__SetOdometry_Response__Sequence response;
} robotnik_controllers_msgs__srv__SetOdometry_Event;

// Struct for a sequence of robotnik_controllers_msgs__srv__SetOdometry_Event.
typedef struct robotnik_controllers_msgs__srv__SetOdometry_Event__Sequence
{
