...
class Init_SetOdometry_Event_response
{
public:
  explicit Init_SetOdometry_Event_response(::robotnik_controllers_msgs::srv::SetOdometry_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_controllers_msgs::srv::SetOdometry_Event response(::robotnik_controllers_msgs::srv::SetOdometry_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_controllers_msgs::srv::SetOdometry_Event msg_;
};

class Init_SetOdometry_Event_request
{
public:
  explicit Init_SetOdometry_Event_request(::robotnik_controllers_msgs::srv::SetOdometry_Event & msg)
  : msg_(msg)
  {}
  Init_SetOdometry_Event_response request(::robotnik_controllers_msgs::srv::SetOdometry_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetOdometry_Event_response(msg_);
  }
...
class Init_SetOdometry_Event_info
{
public:
  Init_SetOdometry_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetOdometry_Event_request info(::robotnik_controllers_msgs::srv::SetOdometry_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetOdometry_Event_request(msg_);
  }
...
template<>
inline
auto build<::robotnik_controllers_msgs::srv::SetOdometry_Event>()
{
  return robotnik_controllers_msgs::srv::builder::Init_SetOdometry_Event_info();
}
