...
robotnik_controllers_msgs__srv__AvailableKinematics_Request__create(void)
{
...
robotnik_controllers_msgs__srv__AvailableKinematics_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
robotnik_controllers_msgs__srv__AvailableKinematics_Event__init(robotnik_controllers_msgs__srv__AvailableKinematics_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(msg);
    return false;
  }
  // request
  if (!robotnik_controllers_msgs__srv__AvailableKinematics_Request__Sequence__init(&msg->request, 0)) {
    robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(msg);
    return false;
  }
  // response
  if (!robotnik_controllers_msgs__srv__AvailableKinematics_Response__Sequence__init(&msg->response, 0)) {
    robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(msg);
    return false;
  }
  return true;
...
void
robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(robotnik_controllers_msgs__srv__AvailableKinematics_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  robotnik_controllers_msgs__srv__AvailableKinematics_Request__Sequence__fini(&msg->request);
  // response
  robotnik_controllers_msgs__srv__AvailableKinematics_Response__Sequence__fini(&msg->response);
}

bool
robotnik_controllers_msgs__srv__AvailableKinematics_Event__are_equal(const robotnik_controllers_msgs__srv__AvailableKinematics_Event * lhs, const robotnik_controllers_msgs__srv__AvailableKinematics_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!robotnik_controllers_msgs__srv__AvailableKinematics_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!robotnik_controllers_msgs__srv__AvailableKinematics_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
...
bool
robotnik_controllers_msgs__srv__AvailableKinematics_Event__copy(
  const robotnik_controllers_msgs__srv__AvailableKinematics_Event * input,
  robotnik_controllers_msgs__srv__AvailableKinematics_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!robotnik_controllers_msgs__srv__AvailableKinematics_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!robotnik_controllers_msgs__srv__AvailableKinematics_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
robotnik_controllers_msgs__srv__AvailableKinematics_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_controllers_msgs__srv__AvailableKinematics_Event * msg = (robotnik_controllers_msgs__srv__AvailableKinematics_Event *)allocator.allocate(sizeof(robotnik_controllers_msgs__srv__AvailableKinematics_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotnik_controllers_msgs__srv__AvailableKinematics_Event));
  bool success = robotnik_controllers_msgs__srv__AvailableKinematics_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
robotnik_controllers_msgs__srv__AvailableKinematics_Event__destroy(robotnik_controllers_msgs__srv__AvailableKinematics_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(msg);
...
bool
robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__init(robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_controllers_msgs__srv__AvailableKinematics_Event * data = NULL;

  if (size) {
    data = (robotnik_controllers_msgs__srv__AvailableKinematics_Event *)allocator.zero_allocate(size, sizeof(robotnik_controllers_msgs__srv__AvailableKinematics_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotnik_controllers_msgs__srv__AvailableKinematics_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__fini(robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * array = (robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence *)allocator.allocate(sizeof(robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__destroy(robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__are_equal(const robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * lhs, const robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotnik_controllers_msgs__srv__AvailableKinematics_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence__copy(
  const robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * input,
  robotnik_controllers_msgs__srv__AvailableKinematics_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotnik_controllers_msgs__srv__AvailableKinematics_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotnik_controllers_msgs__srv__AvailableKinematics_Event * data =
      (robotnik_controllers_msgs__srv__AvailableKinematics_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotnik_controllers_msgs__srv__AvailableKinematics_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotnik_controllers_msgs__srv__AvailableKinematics_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotnik_controllers_msgs__srv__AvailableKinematics_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
