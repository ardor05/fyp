...
class Metaclass_AvailableKinematics_Event(type):
    """Metaclass of message 'AvailableKinematics_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__available_kinematics__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__available_kinematics__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__available_kinematics__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__available_kinematics__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__available_kinematics__event
...
class AvailableKinematics_Event(metaclass=Metaclass_AvailableKinematics_Event):
    """Message class 'AvailableKinematics_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robotnik_controllers_msgs/AvailableKinematics_Request, 1>',
        'response': 'sequence<robotnik_controllers_msgs/AvailableKinematics_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_controllers_msgs', 'srv'], 'AvailableKinematics_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_controllers_msgs', 'srv'], 'AvailableKinematics_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robotnik_controllers_msgs.srv import AvailableKinematics_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, AvailableKinematics_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'AvailableKinematics_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from robotnik_controllers_msgs.srv import AvailableKinematics_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, AvailableKinematics_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'AvailableKinematics_Response'"
        self._response = value
...
class Metaclass_AvailableKinematics(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _available_kinematics.Metaclass_AvailableKinematics_Event._TYPE_SUPPORT is None:
                _available_kinematics.Metaclass_AvailableKinematics_Event.__import_type_support__()
...
class AvailableKinematics(metaclass=Metaclass_AvailableKinematics):
    ...
    from robotnik_controllers_msgs.srv._available_kinematics import AvailableKinematics_Event as Event
