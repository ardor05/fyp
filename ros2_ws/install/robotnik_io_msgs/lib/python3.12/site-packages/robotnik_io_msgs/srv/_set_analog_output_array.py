...
class Metaclass_SetAnalogOutputArray_Event(type):
    """Metaclass of message 'SetAnalogOutputArray_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_analog_output_array__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_analog_output_array__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_analog_output_array__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_analog_output_array__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_analog_output_array__event
...
class SetAnalogOutputArray_Event(metaclass=Metaclass_SetAnalogOutputArray_Event):
    """Message class 'SetAnalogOutputArray_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robotnik_io_msgs/SetAnalogOutputArray_Request, 1>',
        'response': 'sequence<robotnik_io_msgs/SetAnalogOutputArray_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_io_msgs', 'srv'], 'SetAnalogOutputArray_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_io_msgs', 'srv'], 'SetAnalogOutputArray_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robotnik_io_msgs.srv import SetAnalogOutputArray_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetAnalogOutputArray_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetAnalogOutputArray_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from robotnik_io_msgs.srv import SetAnalogOutputArray_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetAnalogOutputArray_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetAnalogOutputArray_Response'"
        self._response = value
...
class Metaclass_SetAnalogOutputArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_analog_output_array.Metaclass_SetAnalogOutputArray_Event._TYPE_SUPPORT is None:
                _set_analog_output_array.Metaclass_SetAnalogOutputArray_Event.__import_type_support__()
...
class SetAnalogOutputArray(metaclass=Metaclass_SetAnalogOutputArray):
    ...
    from robotnik_io_msgs.srv._set_analog_output_array import SetAnalogOutputArray_Event as Event
