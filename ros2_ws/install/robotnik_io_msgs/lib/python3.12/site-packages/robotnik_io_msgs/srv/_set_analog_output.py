...
class SetAnalogOutput_Event(metaclass=Metaclass_SetAnalogOutput_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robotnik_io_msgs/SetAnalogOutput_Request, 1>',
        'response': 'sequence<robotnik_io_msgs/SetAnalogOutput_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_io_msgs', 'srv'], 'SetAnalogOutput_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robotnik_io_msgs', 'srv'], 'SetAnalogOutput_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robotnik_io_msgs.srv import SetAnalogOutput_Request
    ...
    def response(self, value):
        if self._check_fields:
            from robotnik_io_msgs.srv import SetAnalogOutput_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetAnalogOutput(metaclass=Metaclass_SetAnalogOutput):
    ...
    from robotnik_io_msgs.srv._set_analog_output import SetAnalogOutput_Event as Event
