...
static rosidl_message_type_support_t robotnik_io_msgs__srv__GetRegisters_Request__rosidl_typesupport_introspection_c__GetRegisters_Request_message_type_support_handle = {
  ...
  &robotnik_io_msgs__srv__GetRegisters_Request__get_type_hash,
  &robotnik_io_msgs__srv__GetRegisters_Request__get_type_description,
  &robotnik_io_msgs__srv__GetRegisters_Request__get_type_description_sources,
};
...
static rosidl_message_type_support_t robotnik_io_msgs__srv__GetRegisters_Response__rosidl_typesupport_introspection_c__GetRegisters_Response_message_type_support_handle = {
  ...
  get_message_typesupport_handle_function,
  &robotnik_io_msgs__srv__GetRegisters_Response__get_type_hash,
  &robotnik_io_msgs__srv__GetRegisters_Response__get_type_description,
  &robotnik_io_msgs__srv__GetRegisters_Response__get_type_description_sources,
};
...
void robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  robotnik_io_msgs__srv__GetRegisters_Event__init(message_memory);
}

void robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_fini_function(void * message_memory)
{
  robotnik_io_msgs__srv__GetRegisters_Event__fini(message_memory);
}

size_t robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__size_function__GetRegisters_Event__request(
  const void * untyped_member)
{
  const robotnik_io_msgs__srv__GetRegisters_Request__Sequence * member =
    (const robotnik_io_msgs__srv__GetRegisters_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_const_function__GetRegisters_Event__request(
  const void * untyped_member, size_t index)
{
  const robotnik_io_msgs__srv__GetRegisters_Request__Sequence * member =
    (const robotnik_io_msgs__srv__GetRegisters_Request__Sequence *)(untyped_member);
...
void * robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_function__GetRegisters_Event__request(
  void * untyped_member, size_t index)
{
  robotnik_io_msgs__srv__GetRegisters_Request__Sequence * member =
    (robotnik_io_msgs__srv__GetRegisters_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__fetch_function__GetRegisters_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const robotnik_io_msgs__srv__GetRegisters_Request * item =
    ((const robotnik_io_msgs__srv__GetRegisters_Request *)
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_const_function__GetRegisters_Event__request(untyped_member, index));
  robotnik_io_msgs__srv__GetRegisters_Request * value =
    (robotnik_io_msgs__srv__GetRegisters_Request *)(untyped_value);
  *value = *item;
}

void robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__assign_function__GetRegisters_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  robotnik_io_msgs__srv__GetRegisters_Request * item =
    ((robotnik_io_msgs__srv__GetRegisters_Request *)
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_function__GetRegisters_Event__request(untyped_member, index));
  const robotnik_io_msgs__srv__GetRegisters_Request * value =
    (const robotnik_io_msgs__srv__GetRegisters_Request *)(untyped_value);
  *item = *value;
}

bool robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__resize_function__GetRegisters_Event__request(
  void * untyped_member, size_t size)
{
  robotnik_io_msgs__srv__GetRegisters_Request__Sequence * member =
    (robotnik_io_msgs__srv__GetRegisters_Request__Sequence *)(untyped_member);
  robotnik_io_msgs__srv__GetRegisters_Request__Sequence__fini(member);
  return robotnik_io_msgs__srv__GetRegisters_Request__Sequence__init(member, size);
}

size_t robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__size_function__GetRegisters_Event__response(
  const void * untyped_member)
{
  const robotnik_io_msgs__srv__GetRegisters_Response__Sequence * member =
    (const robotnik_io_msgs__srv__GetRegisters_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_const_function__GetRegisters_Event__response(
  const void * untyped_member, size_t index)
{
  const robotnik_io_msgs__srv__GetRegisters_Response__Sequence * member =
    (const robotnik_io_msgs__srv__GetRegisters_Response__Sequence *)(untyped_member);
...
void * robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_function__GetRegisters_Event__response(
  void * untyped_member, size_t index)
{
  robotnik_io_msgs__srv__GetRegisters_Response__Sequence * member =
    (robotnik_io_msgs__srv__GetRegisters_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__fetch_function__GetRegisters_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const robotnik_io_msgs__srv__GetRegisters_Response * item =
    ((const robotnik_io_msgs__srv__GetRegisters_Response *)
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_const_function__GetRegisters_Event__response(untyped_member, index));
  robotnik_io_msgs__srv__GetRegisters_Response * value =
    (robotnik_io_msgs__srv__GetRegisters_Response *)(untyped_value);
  *value = *item;
}

void robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__assign_function__GetRegisters_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  robotnik_io_msgs__srv__GetRegisters_Response * item =
    ((robotnik_io_msgs__srv__GetRegisters_Response *)
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_function__GetRegisters_Event__response(untyped_member, index));
  const robotnik_io_msgs__srv__GetRegisters_Response * value =
    (const robotnik_io_msgs__srv__GetRegisters_Response *)(untyped_value);
  *item = *value;
}

bool robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__resize_function__GetRegisters_Event__response(
  void * untyped_member, size_t size)
{
  robotnik_io_msgs__srv__GetRegisters_Response__Sequence * member =
    (robotnik_io_msgs__srv__GetRegisters_Response__Sequence *)(untyped_member);
  robotnik_io_msgs__srv__GetRegisters_Response__Sequence__fini(member);
  return robotnik_io_msgs__srv__GetRegisters_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robotnik_io_msgs__srv__GetRegisters_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(robotnik_io_msgs__srv__GetRegisters_Event, request),  // bytes offset in struct
    NULL,  // default value
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__size_function__GetRegisters_Event__request,  // size() function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_const_function__GetRegisters_Event__request,  // get_const(index) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_function__GetRegisters_Event__request,  // get(index) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__fetch_function__GetRegisters_Event__request,  // fetch(index, &value) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__assign_function__GetRegisters_Event__request,  // assign(index, value) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__resize_function__GetRegisters_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(robotnik_io_msgs__srv__GetRegisters_Event, response),  // bytes offset in struct
    NULL,  // default value
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__size_function__GetRegisters_Event__response,  // size() function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_const_function__GetRegisters_Event__response,  // get_const(index) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__get_function__GetRegisters_Event__response,  // get(index) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__fetch_function__GetRegisters_Event__response,  // fetch(index, &value) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__assign_function__GetRegisters_Event__response,  // assign(index, value) function pointer
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__resize_function__GetRegisters_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_members = {
  "robotnik_io_msgs__srv",  // message namespace
  "GetRegisters_Event",  // message name
  3,  // number of fields
  sizeof(robotnik_io_msgs__srv__GetRegisters_Event),
  false,  // has_any_key_member_
  robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_member_array,  // message members
  robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_type_support_handle = {
  0,
  &robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_members,
  get_message_typesupport_handle_function,
  &robotnik_io_msgs__srv__GetRegisters_Event__get_type_hash,
  &robotnik_io_msgs__srv__GetRegisters_Event__get_type_description,
  &robotnik_io_msgs__srv__GetRegisters_Event__get_type_description_sources,
};

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_robotnik_io_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Event)() {
  robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Request)();
  robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Response)();
  if (!robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_type_support_handle.typesupport_identifier) {
    robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t robotnik_io_msgs__srv__detail__get_registers__rosidl_typesupport_introspection_c__GetRegisters_service_type_support_handle = {
  ...
  &robotnik_io_msgs__srv__GetRegisters_Request__rosidl_typesupport_introspection_c__GetRegisters_Request_message_type_support_handle,
  &robotnik_io_msgs__srv__GetRegisters_Response__rosidl_typesupport_introspection_c__GetRegisters_Response_message_type_support_handle,
  &robotnik_io_msgs__srv__GetRegisters_Event__rosidl_typesupport_introspection_c__GetRegisters_Event_message_type_support_handle,
  ...
  &robotnik_io_msgs__srv__GetRegisters__get_type_hash,
  &robotnik_io_msgs__srv__GetRegisters__get_type_description,
  &robotnik_io_msgs__srv__GetRegisters__get_type_description_sources,
};

// Forward declaration of message type support functions for service members
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_robotnik_io_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotnik_io_msgs, srv, GetRegisters_Event)()->data;
  }
