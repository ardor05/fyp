...
enum
{
  robotnik_io_msgs__srv__SetRegisters_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_io_msgs__srv__SetRegisters_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetRegisters in the package robotnik_io_msgs.
typedef struct robotnik_io_msgs__srv__SetRegisters_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_io_msgs__srv__SetRegisters_Request__Sequence request;
  robotnik_io_msgs__srv__SetRegisters_Response__Sequence response;
} robotnik_io_msgs__srv__SetRegisters_Event;

// Struct for a sequence of robotnik_io_msgs__srv__SetRegisters_Event.
typedef struct robotnik_io_msgs__srv__SetRegisters_Event__Sequence
{
