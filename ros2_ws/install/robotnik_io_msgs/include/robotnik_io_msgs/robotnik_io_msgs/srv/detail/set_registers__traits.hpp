...
inline std::string to_yaml(const SetRegisters_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use robotnik_io_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const robotnik_io_msgs::srv::SetRegisters_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  robotnik_io_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use robotnik_io_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const robotnik_io_msgs::srv::SetRegisters_Event & msg)
{
  return robotnik_io_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<robotnik_io_msgs::srv::SetRegisters_Event>()
{
  return "robotnik_io_msgs::srv::SetRegisters_Event";
}

template<>
inline const char * name<robotnik_io_msgs::srv::SetRegisters_Event>()
{
  return "robotnik_io_msgs/srv/SetRegisters_Event";
}

template<>
struct has_fixed_size<robotnik_io_msgs::srv::SetRegisters_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<robotnik_io_msgs::srv::SetRegisters_Event>
  : std::integral_constant<bool, has_bounded_size<robotnik_io_msgs::srv::SetRegisters_Request>::value && has_bounded_size<robotnik_io_msgs::srv::SetRegisters_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<robotnik_io_msgs::srv::SetRegisters_Event>
  : std::true_type {};
