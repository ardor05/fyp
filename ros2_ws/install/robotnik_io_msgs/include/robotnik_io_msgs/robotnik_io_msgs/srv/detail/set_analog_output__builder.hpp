...
{
public:
  explicit Init_SetAnalogOutput_Event_response(::robotnik_io_msgs::srv::SetAnalogOutput_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_io_msgs::srv::SetAnalogOutput_Event response(::robotnik_io_msgs::srv::SetAnalogOutput_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_io_msgs::srv::SetAnalogOutput_Event msg_;
};

class Init_SetAnalogOutput_Event_request
{
public:
  explicit Init_SetAnalogOutput_Event_request(::robotnik_io_msgs::srv::SetAnalogOutput_Event & msg)
  : msg_(msg)
  {}
  Init_SetAnalogOutput_Event_response request(::robotnik_io_msgs::srv::SetAnalogOutput_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetAnalogOutput_Event_request info(::robotnik_io_msgs::srv::SetAnalogOutput_Event::_info_type arg)
  {
...
template<>
inline
auto build<::robotnik_io_msgs::srv::SetAnalogOutput_Event>()
{
  return robotnik_io_msgs::srv::builder::Init_SetAnalogOutput_Event_info();
}
