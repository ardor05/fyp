...
enum
{
  robotnik_io_msgs__srv__SetDigitalOutput_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_io_msgs__srv__SetDigitalOutput_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetDigitalOutput in the package robotnik_io_msgs.
typedef struct robotnik_io_msgs__srv__SetDigitalOutput_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_io_msgs__srv__SetDigitalOutput_Request__Sequence request;
  robotnik_io_msgs__srv__SetDigitalOutput_Response__Sequence response;
} robotnik_io_msgs__srv__SetDigitalOutput_Event;

// Struct for a sequence of robotnik_io_msgs__srv__SetDigitalOutput_Event.
typedef struct robotnik_io_msgs__srv__SetDigitalOutput_Event__Sequence
{
