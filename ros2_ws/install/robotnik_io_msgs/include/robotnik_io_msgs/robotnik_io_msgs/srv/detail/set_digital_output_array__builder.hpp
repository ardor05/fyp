...
class Init_SetDigitalOutputArray_Event_response
{
public:
  explicit Init_SetDigitalOutputArray_Event_response(::robotnik_io_msgs::srv::SetDigitalOutputArray_Event & msg)
  : msg_(msg)
  {}
  ::robotnik_io_msgs::srv::SetDigitalOutputArray_Event response(::robotnik_io_msgs::srv::SetDigitalOutputArray_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::robotnik_io_msgs::srv::SetDigitalOutputArray_Event msg_;
};

class Init_SetDigitalOutputArray_Event_request
{
public:
  explicit Init_SetDigitalOutputArray_Event_request(::robotnik_io_msgs::srv::SetDigitalOutputArray_Event & msg)
  : msg_(msg)
  {}
  Init_SetDigitalOutputArray_Event_response request(::robotnik_io_msgs::srv::SetDigitalOutputArray_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetDigitalOutputArray_Event_response(msg_);
  }
...
class Init_SetDigitalOutputArray_Event_info
{
public:
  Init_SetDigitalOutputArray_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetDigitalOutputArray_Event_request info(::robotnik_io_msgs::srv::SetDigitalOutputArray_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetDigitalOutputArray_Event_request(msg_);
  }
...
template<>
inline
auto build<::robotnik_io_msgs::srv::SetDigitalOutputArray_Event>()
{
  return robotnik_io_msgs::srv::builder::Init_SetDigitalOutputArray_Event_info();
}
