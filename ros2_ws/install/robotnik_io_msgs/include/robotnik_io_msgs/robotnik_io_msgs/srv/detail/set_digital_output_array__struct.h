...
enum
{
  robotnik_io_msgs__srv__SetDigitalOutputArray_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_io_msgs__srv__SetDigitalOutputArray_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetDigitalOutputArray in the package robotnik_io_msgs.
typedef struct robotnik_io_msgs__srv__SetDigitalOutputArray_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_io_msgs__srv__SetDigitalOutputArray_Request__Sequence request;
  robotnik_io_msgs__srv__SetDigitalOutputArray_Response__Sequence response;
} robotnik_io_msgs__srv__SetDigitalOutputArray_Event;

// Struct for a sequence of robotnik_io_msgs__srv__SetDigitalOutputArray_Event.
typedef struct robotnik_io_msgs__srv__SetDigitalOutputArray_Event__Sequence
{
