...
enum
{
  robotnik_io_msgs__srv__GetRegisters_Event__request__MAX_SIZE = 1
};
// response
enum
{
  robotnik_io_msgs__srv__GetRegisters_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetRegisters in the package robotnik_io_msgs.
typedef struct robotnik_io_msgs__srv__GetRegisters_Event
{
  service_msgs__msg__ServiceEventInfo info;
  robotnik_io_msgs__srv__GetRegisters_Request__Sequence request;
  robotnik_io_msgs__srv__GetRegisters_Response__Sequence response;
} robotnik_io_msgs__srv__GetRegisters_Event;

// Struct for a sequence of robotnik_io_msgs__srv__GetRegisters_Event.
typedef struct robotnik_io_msgs__srv__GetRegisters_Event__Sequence
{
